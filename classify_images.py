...
def run_inference_on_image(row, writer, dict):
  ...
  with tf.Session() as sess:
    ...
    writer.writerow((image, str(image_class), pred[0], pred[1], pred[2], pred[3], pred[4]))
...
def main(_):
  ...
  log = open(FLAGS.log_path, 'w')
  writer = csv.writer(log, lineterminator='\n')  # 改行コード（\n）を指定しておく
  writer.writerow(("image path", "class", "prediction 1", "prediction2", "prediction3", "prediction4", "prediction5"))
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--images_file',
      type=str,
      default='/Users/shigetomi/Desktop/dataset_walls/train2.txt',
      help='Absolute path to image file.'
  )
  parser.add_argument(
    '--log_path',
    type=str,
    default='/Users/shigetomi/workspace/tensorflow_works/log/log.csv',
    help='Absolute path to image file.'
  )
  parser.add_argument(
      '--num_top_predictions',
