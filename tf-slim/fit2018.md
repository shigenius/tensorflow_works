...
* Train時とTest時のlabelのidが変わっていないか
  - 変わっている場合は[script/replace_labelid.py](https://github.com/shigenius/tensorflow_works/blob/master/tf-slim/script/replace_labelid.py)でlabelidを置き換えることができます．
